...
namespace WEBPages.MyPCPages
{
    ...
    public class UploadScriptDialog : FirstLevelDialog
    {
        ...
        protected override WebElement btnClose 
        { get {return dialog.GetElement().ById(Locators.btnCloseId);} }
        
        private WebElement btnSelect 
        { get { return dialog.GetElement().ByXPath(Locators.btnSelectXpath); } }

        private WebElement btnUpload 
        { get { return dialog.GetElement().ById(Locators.btnUploadId); } }
